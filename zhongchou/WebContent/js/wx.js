...
*/
mpath="localhost:8080/zhongchou/";
...
//        	  }
//          }else{
//        	  wx.alert(json.errortext);
//          }
          var backData=eval('(' + re + ')');
          ...
          if(backData[wx.config.dataFlag] == wx.config.dataDefaultAlertVal && (options.alertPrompt !== undefined ? options.alertPrompt : true)){
            wx.alert(backData.errortext || backData.info,function(){if(callback) callback.call(options.context || _this, backData, options.extData);});
          } else {
            if(callback === wx.RELOAD)
              ...
              callback.call(options.context||_this, backData, options.extData);
            	 ...
            	 if(backData.status){
               	  if(backData.url!=null&&backData.url!=''){
               		  window.location.href=backData.url;
               	  }else{
               		  callback.call(_this,backData);
               	  }
                 }else{
               	  wx.alert(backData.errortext);
                 }
            }
          }
  ...
  */
  ...
  wx.popi = function(content, callback, opts) {
	    if(!content) return;
	    if(!$.isFunction(callback) && $.type(callback) === "object")
	      opts = callback;
	    opts = opts || {};
      ...
      */
      ...
      function loginDialog(){
        var loginTpl = '<div class="titleWrap"><div class="title">登录<a class="shut-down-icon Js-pop-close"></a></div></div>\
                       ...
                       <form action="log.jsp" wx-validator wx-validator-ajax name="loginForm" wx-validator-single-error="registerFormError">\
                      <input type="hidden" name="m" value="login"> <div class="logleft"><span id="registerFormError" class="error-text"></span>\
                       ...
                       <div class="shell clearfix"><input type="password"  name="password" wx-validator-rule="required|rangelength" wx-validator-param="|3-16"  wx-validator-user_pwd-required="*请输入密码" wx-validator-placeholder="密码"></div>\
                       <div class="numwrap shell clearfix hidden"><input disabled="disabled" id="v_code" type="text" name="code" wx-validator-code-required="*请输入图形验证码" wx-validator-placeholder="验证码"><a href="javascript:;"><img style="width:78px;height:40px;"\
                    	src="ImageServlet" onclick="this.src=\'/ImageServlet?\' + Math.random();" class="get-verification-code" />\
                       </a></div>\
                       ...
                       <div class="logright" style="padding-left: 25px;">\
                      <!-- <div class="shell zhdl2"><a class="Js-mshowLogin" href="javascript:;">手机短信登录</a></div>\
                       <div class="shell login">没有账号？<a class=" fonthov" href="reg.shtml">快速注册</a></div>\
                       ...
                       --> <div class="shell login">没有账号？<a class=" fonthov" href="reg.shtml">快速注册</a></div><img src="images/login-logo.jpg"></div>\
                       </form>\
                       </div>'; 
        ...
        var mloginTpl = '<div class="titleWrap"><div class="title">登录<a class="shut-down-icon Js-pop-close"></a></div></div>\
                        <div class="logwrap clearfix">\
                        <form action="log.jsp" wx-validator wx-validator-ajax name="mloginForm" wx-validator-single-error="registerFormError">\
      	  <input type="hidden" name="m" value="login"> <div class="logleft"><span id="registerFormError" class="error-text"></span>\
        ...
        var registerTpl = '<div class="titleWrap"><div class="title">注册<a class="shut-down-icon Js-pop-close"></a></div></div>\
                        ...
                        src="/verify.php" onclick="this.src=\'/verify.php?\' + Math.random();" class="get-verification-code" />\
                          ...
                          <div class="shell clearfix"><input type="text"  name="password" wx-validator-user_pwd-required="*请输入密码" wx-validator-rule="required|rangelength" wx-validator-param="|3-16"  wx-validator-placeholder="密码"></div>\
        ...
        $(".Js-showLogin").live("click",function(){
          ...
          wx.popi(loginTpl,{shown:loginTplCallback});
        });
      ...
      function loginForm(data){
        if(!data.status){
          $("#registerFormError").text(data.errortext);
      ...
      function googleAnalytics(){
        ...
        ga.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + mpath+'js/dc.js';
