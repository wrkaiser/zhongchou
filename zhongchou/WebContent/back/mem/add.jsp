...
<%@page import="java.util.List"%>
 <%
                  ...
                  if(m!=null&&m.equals("insert")){
                      sql="insert into  zh_users(userid,username,telno,province,addtime,lasttime,ischecked)  values("+request.getParameter("userid")+",'"+request.getParameter("username")+"','"+
      request.getParameter("telno")+"','"+request.getParameter("province")+"',unix_timestamp(),unix_timestamp(),"+request.getParameter("status")+")";
               	   	dao.update(sql);
               	 out.print("{\"errno\":\"0\",\"tip\":\"保存成功\",\"url\":\""+request.getContextPath()+"/back/mem/allmems.jsp"+"\"}");
               	   	return;
                  }
                  %>         
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>添加会员</h3>
                            </div>
                        ...
                        <div class="box-content">
                            <form id="replyform" name="replyform"  action="add.jsp" method="post" class="form-horizontal form-validate" onsubmit="return updateText();">
                            <input type="hidden" name="id" value="${empty detail ? 0: detail.id}" />
                            <input type="hidden" name="m" value="insert" />
                                  <div class="control-group">
                                    <label for="name" class="control-label">会员名字</label>
                                    <div class="controls">
                                        <input type="text"  name="username" id="label" class="input-large" data-rule-required="true" data-rule-maxlength="200" />
                                        <span class="maroon">*</span>
                                      
                                    </div>
                                </div>
                                  <div class="control-group">
                                    <label class="control-label" for="shopid">会员电话：</label>
                                    <div class="controls">
                                       <input type="text"  name="telno" id="label" class="input-large" data-rule-required="true" data-rule-maxlength="200" />
										
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="shopid">省份：</label>
                                    <div class="controls">
                                       <input type="text"  name="province" id="label" class="input-large" data-rule-required="true" data-rule-maxlength="200" />
                                ...
                                <div class="control-group">
                                    <label for="sort" class="control-label">是否审核通过？：</label>
                                    <div class="controls">
                                    <select name="status" >
