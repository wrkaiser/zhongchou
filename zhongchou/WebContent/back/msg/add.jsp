            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>最新${msg.type}</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <input type="hidden" name="m" value="save" />
                                  <div class="control-group" >
                                    <label for="name" class="control-label">${msg.type}内容：</label>
                                    <div class="controls">
                                        ${msg.content}
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label class="control-label" for="detail">回复:</label>
                                    <div class="controls">
                                        <textarea id="info" name="rescontent" style="width: 70%; height:100px" >${msg.rescontent}</textarea>
