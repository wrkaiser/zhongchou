...
<%
	...
	if(m!=null&&m.equals("delete")){
		...
		sql="delete from zh_pro_collects where id="+id;
		dao.delete(sql);
	}
	
	pageinfo.setQueryStr("zh_pro_collects.userid="
			+ userid
			+ "  and zh_pro_collects.proid=zh_pros.proid and zh_pros.userid=zh_users.userid order by  zh_pros.addtime");
	pageinfo.setCurrentPage(p);
	List<Map> list = dao.getListByPage("zh_pros , zh_pro_collects ,zh_users ",
			"zh_pros.*,zh_pro_collects.id,zh_users.username", pageinfo);
...
<title>${pageinfio.name}_我关注的项目</title>
			...
			<div class="user_l">
				...
				<div class="project-info">
					<ul>
						...
						<li class="selected"><a href="${pageContext.request.contextPath}/center/mycollect.shtml">关注的项目</a></li>
			...
			<div class="user_r">
					...
					<logic:iterate id="l" name="list">
						...
						<div class="project-list-content clearfix">
							<ul>
								...
								<li class="cell03"><em>${l.financialneeds}</em>
								<p></p></li>
                               ...
                               <li class="cell04">
								...
								<li class="cell07"><a 
									href="${pageContext.request.contextPath}/center/mycollect.jsp?id=${l.id}&m=delete" />取消关注</a></li>
							</ul>
				...
				<logic:greaterThan value="1" name="pageinfo" property="totalPages">
					<mytag:commonpage currentPage="${pageinfo.currentPage}"
						...
						url="${pageContext.request.contextPath}/center/mycollect.jsp?"
