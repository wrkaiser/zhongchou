	...
	<div class="m-subnav">
		<div class="wrap">
			...
			<div class="m-nav-left">
				<ul>
					<li class="selected"><a
						href="${pageContext.request.contextPath}/deal/list.html">全部</a></li>
					<logic:notEmpty name="cate">
						<logic:iterate id="c1" name="cate">
							<li><a
								href="${pageContext.request.contextPath}/deal/list/${c1.id}.html">${c1.name}</a></li>
						</logic:iterate>
					</logic:notEmpty>
	...
	<div class="wrap m-box ">
		<div class="deputy-nav clearfix">
			<div class="m-deputy-left">
				<a class="select" href="${pageContext.request.contextPath}/deal/list.html"><label>
						众筹中(${count})</label></a>
				<ul class="ul-slide">
					...
					<li class="end"><a href="${pageContext.request.contextPath}/deal/willStartList.html">即将开始(${count3})</a></li>
				</ul>
			</div>
			<div class="m-deputy-left">
				<a href="${pageContext.request.contextPath}/deal.do?m=list&c=${c}"><label>
						默认排序</label></a>
				<ul class="ul-slide">
					<li><a
						href="${pageContext.request.contextPath}/deal.do?x=zxsx&m=list&c=${c}">最新上线</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?x=zgje&m=list&c=${c}">最高目标金额</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?x=zdzcrs&m=list&c=${c}">最多支持人数</a></li>
					<li class="end"><a
						href="${pageContext.request.contextPath}/deal.do?x=zdzcje&m=list&c=${c}">最多支持金额</a></li>
				</ul>
			</div>
		</div>
		<div class="focus-box">
           ...
           <logic:greaterThan value="1" name="pageinfo" property="totalPages">
					<mytag:commonpage currentPage="${pageinfo.currentPage}"
						...
						url="${pageContext.request.contextPath}/deal.do?x=${x}&c=${c}"
