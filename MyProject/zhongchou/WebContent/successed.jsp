	...
	<div class="m-subnav">
		<div class="wrap">
			...
			<div class="m-nav-left">
				<ul>
					<li class="selected"><a
						href="${pageContext.request.contextPath}/deal/successedList.html">全部</a></li>
					<logic:notEmpty name="cate">
						<logic:iterate id="c1" name="cate">
							<li><a
								href="${pageContext.request.contextPath}/deal/successedList/${c1.id}.html">${c1.name
									}</a></li>
						</logic:iterate>
					</logic:notEmpty>
	...
	<div class="wrap m-box ">
		<div class="deputy-nav clearfix">
			<div class="m-deputy-left">
				<a class="select"
					href="${pageContext.request.contextPath}/deal/successedList.html"> <label>已成功(${count2})
				</label></a>
				<ul class="ul-slide">
			...
			<div class="m-deputy-left">
				<a href="${pageContext.request.contextPath}/deal.do?m=successedList&c=${c }"><label>
						默认排序</label></a>
				<ul class="ul-slide">
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=successedList&c=${c }&x=zxsx">最新上线</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=successedList&c=${c }&x=zgje">最高目标金额</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=successedList&c=${c }&x=zdzcrs">最多支持人数</a></li>
					<li class="end"><a
						href="${pageContext.request.contextPath}/deal.do?m=successedList&c=${c }&x=zdzcje">最多支持金额</a></li>
				</ul>
			</div>
		</div>
		...
		<logic:greaterThan value="1" name="pageinfo" property="totalPages">
			<mytag:commonpage currentPage="${pageinfo.currentPage}"
				...
				url="${pageContext.request.contextPath}/deal.do?m=successedList&x=${x }&c=${c}"
