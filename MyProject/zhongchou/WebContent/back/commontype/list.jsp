...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<meta content="微哇，国内最大的微信公众智能服务平台，微哇八大微体系：微菜单、微官网、微会员、微活动、微商城、微推送、微服务、微统计，企业微营销必备。" name="Description">
...
function changet(obj){
   window.location.href="${pageContext.request.contextPath}/back/commontype.do?m=list&id="+$(obj).val();
}
</script>
</head>
<body>
                    ...
                    <div class="box">
                        ...
                        <div class="box-content nozypadding">
                            <div class="span8 control-group">
                                    <a href="${pageContext.request.contextPath }/back/commontype.do?m=detail&t=${id}" class="btn"><i class="icon-plus"></i>添加分类</a>
                                   <!--  <select name="aclassid" class="input-medium" onchange="changet(this)" style="margin:1px 20px 0" id="cate">
                                        <option value="0">根分类</option>
                                        <logic:iterate id="p" name="plist">
                                         <option value="${p.cid}" ${id==p.cid?'selected':''}>${p.cname}</option>
                                        </logic:iterate>
                                        </select> -->
                            </div>
 ...
 <th>类型</th>
                                     ...
                                     <tr>
                                        ...
                                        <td class='input-medium'>
                                            <a class="btn" href="${pageContext.request.contextPath }/back/commontype/detail/${l.id}.html" title="编辑"><i class="icon-edit"></i></a>
                                            <a class="btn" href="javascript: G.ui.tips.confirm('确定删除？','${pageContext.request.contextPath }/back/commontype.do?m=del&id=${l.id }')" title="删除"><i class="icon-remove"></i></a>
