	...
	<div class="m-subnav">
		<div class="wrap">
			...
			<div class="m-nav-left">
				<ul>
					<li class="selected"><a
						href="${pageContext.request.contextPath}/deal/willStartList.html">全部</a></li>
					<logic:notEmpty name="cate">
						<logic:iterate id="c1" name="cate">
							<li><a
								href="${pageContext.request.contextPath}/deal/willStartList/${c1.id}.html">${c1.name
									}</a></li>
						</logic:iterate>
					</logic:notEmpty>
	...
	<div class="wrap m-box ">
		<div class="deputy-nav clearfix">
			<div class="m-deputy-left">
				<a class="select"
					href="${pageContext.request.contextPath}/deal/willStartList.html"><label>
						即将开始(${count3})</label></a>
				<ul class="ul-slide">
					<li><a href="${pageContext.request.contextPath}/deal/list.html">众筹中(${count})</a></li>
					<li><a href="${pageContext.request.contextPath}/deal/allProsList.html">所有项目(${count1})</a></li>
					<li><a href="${pageContext.request.contextPath}/deal/successedList.html">已成功(${count2})</a></li>
				</ul>
			</div>
			<div class="m-deputy-left">
				<a href="${pageContext.request.contextPath}/deal.do?m=willStartList&c=${c}"><label>
						默认排序</label></a>
				<ul class="ul-slide">
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=willStartList&c=${c}&x=zxsx">最新上线</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=willStartList&c=${c}&x=zgje">最高目标金额</a></li>
					<li><a
						href="${pageContext.request.contextPath}/deal.do?m=willStartList&c=${c}&x=zdzcrs">最多支持人数</a></li>
					<li class="end"><a
						href="${pageContext.request.contextPath}/deal.do?m=willStartList&c=${c}&x=zdzcje">最多支持金额</a></li>
				</ul>
			</div>
		</div>
					...
					<logic:iterate id="l" name="list">
						<li>
							<div class="list-item" style="background: #FFF">
								...
								<div class="z-lump ">
									<h2>
										<a target="_blank" href="${pageContext.request.contextPath}/deal/proDetail/${l.proid}.html">${l.proname}</a>
									</h2>
								...
								<p class="z-assist clearfix">
									<a class="assist1" target="_blank" title="喜欢数"
										...
										href="${pageContext.request.contextPath}/deal/proDetail/${l.proid}.html">${l.comms}</a>
								</p>
							</div>
						</li>
					</logic:iterate>
		...
		<logic:greaterThan value="1" name="pageinfo" property="totalPages">
			<mytag:commonpage currentPage="${pageinfo.currentPage}"
				...
				url="${pageContext.request.contextPath}/deal.do?m=willStartList&x=${x }&c=${c}"
